...
- (void)showInViewController:(UIViewController *)presentingViewController
{
    ...
    if (stillExists) {
        UIAlertController *deleteWarning = [UIAlertController alertControllerWithTitle:[NSString stringWithFormat:@"Delete %@?", self.path.lastPathComponent]
        ...
        [deleteWarning addAction:cancelAction];

        UIAlertAction *deleteAction = [UIAlertAction actionWithTitle:@"Delete" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
            [self.delegate fileOperationControllerDidDismiss:self];
        }];
        [deleteWarning addAction:deleteAction];
        [presentingViewController presentViewController:deleteWarning animated:YES completion:nil];
        ...
        [presentingViewController presentViewController:warning animated:YES completion:nil];
    }
}
